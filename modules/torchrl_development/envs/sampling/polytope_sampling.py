#!/usr/bin/env python3
# from https://github.com/jonls/dikin_walk/blob/master/dikin_walk.py
...
def main():
    ...
    # collect chains in serial
    chains = []
    for c in range(chain_count):
        chains.append(collect_chain(sampler, count, burn, thin, a, b, x0, *sampler_args))
