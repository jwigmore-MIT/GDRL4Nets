...
from modules.torchrl_development.agents.actors import create_actor_critic, create_independent_actor_critic
...
parser.add_argument('--training_set_folder', type=str, help='folder containing agents trained according to a particular training set', default="MP5_0-5")
# add argument for context set file name
parser.add_argument('--context_set_file_name', type=str, help='file name of context set', default="MP5_context_set_l3_m1_s100.json")
