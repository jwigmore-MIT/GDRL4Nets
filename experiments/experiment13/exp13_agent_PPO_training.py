...
experiment_name = f"{args.agent_type}_{args.training_set}_{args.context_set}"

context_set_json = context_set_jsons[args.context_set]
...
context_set_dict = json.load(open(context_set_json, 'rb'))
