...
experiment_name = "MaxWeight_NN_model_test"
...
# weights = torch.Tensor([0.184143128, 0.070665115, 0.244402128, 0.415735991, 0.085053645])
weights = torch.Tensor([0.182233, 0.071877, 0.242221, 0.416751, 0.08691 ])
MW_NN = MaxWeightNetwork(int(input_shape[0]/2), weights=weights)
...
with torch.no_grad(), set_exploration_type(ExplorationType.MODE):
    ...
    for i in pbar:
        ...
        for j in range(cfg.eval.num_eval_envs):
            ...
            td = env.rollout(cfg.eval.traj_steps, MW_NN_agent)
