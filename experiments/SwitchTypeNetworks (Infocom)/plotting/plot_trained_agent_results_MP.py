...
training_set_folder = "MP5_0-5"
context_set_file_name = "MP5_context_set_l3_m1_s100.json"
...
# plot histogram of the uncipped data
fig1, ax1 = plt.subplots(1, 1, figsize=(15, 10))
ax1.hist(unclipped_data, alpha=0.8, label=["MLP", "STN"], bins = 30)
# ax1.set_xlim(0, threshold)
# ax1.set_ylim(0, 30)
ax1.set_ylabel("Frequency")
ax1.set_xlabel("Normalized Mean Backlog")
fig1.legend()
fig1.show()
...
# remove x tick labels for the right plot except for the last 2
